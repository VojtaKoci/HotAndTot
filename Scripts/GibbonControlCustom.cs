...
namespace Wolfire
{
    public class GibbonControlCustom : MonoBehaviour {
        public GameObject display_gibbon; // Character mesh and bone transforms

        #region custom classes / structs
        // single bone
        class DisplayBone {
        ...
        //collection of bones = whole body
        class DisplayBody {
        ...
        // Particle simulation systems = verlet systems
        ...
        //Movement system = animation type — walk, run, idle, jump, etc.
        ...
        #region debug values initialization
        ...
        class DebugInfo {
            ...
            //custom method for displaying the debug info
        ...
        void Start() {
            #region initialize starting values, binding, etc.
            // Starting point
        ...
        #region two bone IK calculation
        ...
        //move a point towards another point by maximum distance
        ...
        //prevent arms clipping through body??
        ...
        void Step(float step) {
            ...
            #region landing prediction calculation
